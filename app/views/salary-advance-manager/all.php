   ...
   `),
            ...
            beforeEdit: function (e) {
                if (!e.model.isNew()) {
                    ...
                    const {hr_approval_editable} = e.model;
                    e.model.fields['hr_approval'].editable = hr_approval_editable;
            ...
            edit: function (e) {
                ...
                let textAreaHrComment = e.container.find('.k-edit-field:eq(6) textarea');
