        ...
        <div class="row mbr-justify-content-center">
            ...
            <div class="col-lg-6 mbr-col-md-10">
                <div class="wrap">
                    ...
                    <div class="text-wrap vcenter">
                        ...
                        <p class="mbr-fonts-style text1 mbr-text display-6">
                            <span>All HR-related forms.</span>
                            <span class="invisible">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mbr-col-md-10">
                <div class="wrap">
                    ...
                    <div class="text-wrap vcenter">
                        ...
                        <p class="mbr-fonts-style text1 mbr-text display-6">
                            <span>All Admin-related forms.</span>
                            <span class="invisible">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mbr-col-md-10">
                <div class="wrap">
                    ...
                    <div class="text-wrap vcenter">
                        ...
                        <p class="mbr-fonts-style text1 mbr-text display-6">
                            <span>All IT-related forms.</span>
                            <span class="invisible">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="wrap">
                ...
                <div class="text-wrap vcenter">
                    ...
                    <p class="mbr-fonts-style text1 mbr-text display-6">
                        <span>All HSE-related forms.</span>
                        <span class="invisible">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</span>
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-6 mbr-col-md-10">
                <div class="wrap">
                    ...
                    <div class="text-wrap vcenter">
                        ...
                        <p class="mbr-fonts-style text1 mbr-text display-6">
                            <span>All Mining-related forms.</span>
                            <span class="invisible">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</span>
                        </p>
                    </div>
                </div>
