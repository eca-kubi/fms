          ...
          /*  save: function (e) {
            ...
            columns: [
                {
                    ...
                    command: [{
                        ...
                        click: function (e) {
                            ...
                            let bulkRequestNumber = grid.dataItem($(e.currentTarget).closest("tr")).bulk_request_number;
                            window.location.href = URL_ROOT + "/salary-advance/bulk-requests/"  + bulkRequestNumber;
                        }
                    },
                        {
                            name: "print",
            ...
            dataBound: function (e) {
                ...
                $.each(data, function (i, row) {
                    $('tr[data-uid="' + row.uid + '"] ').attr('data-id', row['id']).find(".print-it").attr("href", URL_ROOT + "/salary-advance/print-bulk-request/" + row["id"]);
                });
                $(".print-it").printPage();
