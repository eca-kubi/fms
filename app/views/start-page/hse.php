<?php /** @var array $payload */ /** @noinspection PhpIncludeInspection */ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row mbr-justify-content-center">
    ...
    <div class="col-lg-4 mbr-col-md-10" data-url="https://adamusgh.com/apps/incident-alert">
        <div class="wrap">
            ...
            <div class="text-wrap w-75">
                <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5 m-0">Incident Alert<span></span></h2>
                <p class="mbr-fonts-style text1 mbr-text desc">
    ...
    <div class="col-lg-4 mbr-col-md-10" data-url="https://adamusgh.com/apps/near-miss">
        <div class="wrap">
            <div class="ico-wrap w-25 mr-5">
                <span class="mbr-iconfont">
                    <?php require APP_ROOT . '\views\includes\svg-icons\vest.svg'; ?>
            ...
            <div class="text-wrap w-75">
                <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5 m-0"> Near Miss<span></span></h2>
                <p class="mbr-fonts-style text1 mbr-text desc">
