...
<div class="row mbr-justify-content-center">
    <div class="col-lg-4 mbr-col-md-10" data-url="<?php echo site_url('visitor-access'); ?>">
        <div class="wrap">
            <div class="ico-wrap">
                <span class="mbr-iconfont fontastic-001-engineer-2 fa"></span>
            </div>
            <div class="text-wrap">
                <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5 m-0">Visitor Access<span></span>
                </h2>
                <p class="mbr-fonts-style text1 mbr-text desc">
                    <span>Fill a visitor access form.</span>
                </p>
            </div>
        </div>
    </div>
